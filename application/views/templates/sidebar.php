...
<div id="wrapper">
  ...
  <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item active">
      <a class="nav-link pb-0" href="<?= base_url(strtolower($this->session->userdata('user')['nama_level']) . $sm['url']); ?>">
        <i class="<?= $sm['icon']; ?>"></i>
        <span><?= $sm['submenu']; ?></span></a>
    </li>
    <?php else : ?>
    <li class="nav-item">
      <a class="nav-link pb-1" href="<?= base_url(strtolower($this->session->userdata('user')['nama_level']) . $sm['url']); ?>">
        <i class="<?= $sm['icon']; ?>"></i>
        <span><?= $sm['submenu']; ?></span></a>
    </li>
    <?php endif; ?>
